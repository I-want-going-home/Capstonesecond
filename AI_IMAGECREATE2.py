...
lora_model_id = r"C:\Users\User1\Documents\GitHub\Capstonesecond\AI\LogoAI\logo_v1-000012.safetensors"

# CUDA가 사용 가능한지 확인하고, 적절한 dtype 설정
...
# LoRA 가중치 로드 및 적용
lora_weights = safetensors.torch.load_file(lora_model_id, device=device)
...
# 저장할 경로 설정
output_folder = r"C:\Users\User1\Documents\GitHub\Capstonesecond\AI\CreatedLogo"
